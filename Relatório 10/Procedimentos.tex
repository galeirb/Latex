...
Para uma melhor visualização, a escala dos dois gráficos estão diferentes.
...
\centerline{\begin{minipage}[c]{\textwidth}
	...
	\begin{tabular}{ll|c|}
		...
		\multicolumn{1}{|l|}{\multirow{3}{*}{Bode Plotter}} & $A_V$ em frequências médias $ (dB) $   &       $ 28,8 $     \\ \cline{2-3} 
		\multicolumn{1}{|l|}{}                              & frequência $ 1 $ a $ (-3dB) $ &      $ 454,523mHz  $  \\ \cline{2-3} 
		\multicolumn{1}{|l|}{}                              & frequência $ 2 $ a $ (-3dB) $ &        $ 7,256MHz $    \\ \hline
	\end{tabular}
		\legend{Fonte: Produzido pelos autores}
		\label{Tab_Circuito1}
\end{minipage}}
...
\centerline{\begin{minipage}[c]{\textwidth}
		...
		\begin{tabular}{ll|c|}
			...
			\multicolumn{1}{|l|}{\multirow{3}{*}{Bode Plotter}} & $A_V$ em frequências médias $ (dB) $   &       $ 7,62 $     \\ \cline{2-3} 
