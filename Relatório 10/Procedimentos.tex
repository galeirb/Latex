...
\begin{enumerate}
	...
	\centerline{\begin{minipage}[c]{\textwidth}
			...
			\begin{tabular}{cccccc}
				\toprule
				Variável & Circuito $ 1 $ & Circuito $ 2 $ & Circuito $ 3 $ (\%) \\
				\midrule \midrule
				$V_e$ $ (V_{pp}) $ &   &  &  \\
				\midrule
				$V_s$ $ (V_{pp}) $ &   &  &  \\
...
\centerline{\begin{minipage}[c]{\textwidth}
		...
		\begin{tabular}{cccccc}
			...
			$V_B$ &  $ 2,69V $ & $ 0,67V $ & $1,5 \% $ \\
			\midrule
			$V_E$ &  $ 1,992V $ & $ 0,015V $ & $1,5 \% $ \\
			\midrule
			$V_{CE}$ &  $ 5,26V $ & $ 5,32 V $ & $1,5 \% $ \\
			\midrule
			$V_{BE}$ &  $ 0,7V $ & $ 5,32 V $ & $1,5 \% $ \\
			\midrule
			$V_{BC}$ &  $ -20,05V $ & $ 5,32 V $ & $1,5 \% $ \\
			\midrule
			$I_{C}$ &  $ 1,98mA$ & $ 6,87 mA $ & $ 699 \% $ \\
			\midrule
			$I_{B}$ &  $ 6,66\mu A $ & $ 34,44\mu A $ & $ 1,55\% $ \\
			\midrule
			$I_{E}$ &  $ 1,992mA$ & $ 6,87 mA $ & $ 699 \% $ \\
			\midrule
			$\beta_{CC}$ & $ 298 $ & $ 298 $ & $ 87,68 \% $ \\
			\midrule
			$P_D$ &  $ 10,41 mW $ & $ 36,54mW $ & $ \% $ \\
			\midrule
			\bottomrule
		\end{tabular}%
		\legend{Fonte: Produzido pelos autores}
